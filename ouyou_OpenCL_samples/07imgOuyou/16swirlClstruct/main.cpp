...
affineTransCL(const char* clName, Cbmp bmp[], const float delta)
{
    ...
    param.inWidth=bmp[0].mPdib->biWidth;            // set param
    param.outWidth=bmp[1].mPdib->biWidth;
    param.inHeight=bmp[0].mPdib->biHeight;
    param.outHeight=bmp[1].mAbsHeight;
    param.inPixelPitch=bmp[0].mPixelPitch;
    param.outPixelPitch=bmp[1].mPixelPitch;
    param.inRowPitch=bmp[0].mRowPitch;
    param.outRowPitch=bmp[1].mRowPitch;
    param.delta=delta;

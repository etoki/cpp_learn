//===================================================================
// main.cpp, only 24bpp file
//
// Ubuntu:
// $ g++ -I /opt/AMDAPP/include/ -L /opt/AMDAPP/lib/x86_64/ ../01imgCl/main.cpp effectCl.cpp ../bitmap/bitmap.cpp -lOpenCL
// $ cp Release/clCode.cl .
